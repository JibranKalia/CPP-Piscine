...
/*   Updated: 2017/07/12 17:41:08 by jkalia           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char **argv) {
  ...
  if (len >= 1 && isdigit(argv[1][0])) 
  {
    ...
    std::cout << "float	: " << std::fixed << std::setprecision(1)
              << static_cast<float>(argv[1][0]) << "f" << std::endl;
    std::cout << "double	: " << std::fixed << std::setprecision(1)
              << static_cast<double>(argv[1][0]) << std::endl;
  } else {
    ...
    if (isnan(d) || isinf(d)) {
      ...
      std::cout << "float	: Undefined" << std::endl;
      std::cout << "double	: Undefined" << std::endl;
    }
  }
